...
| C-03 | Done | Product design | Build address-first, exact-district, delegation, compose, verification, one-submit preview, and per-office result flow | Start + compose screens; focused tests |
